...
***IMPORTANT:*** *If you do not have back padals working (You see a dualshock and NOT a DualSense controller in Steam), simply switch* 
*to desktop mode and then back to game mode and it will show up correctly. You should only ever have to do this if your system dies*
*or you do a full restart.*
