...
KERNEL_FILE="kernel-6.6.7-201.fsync.ally.fc38.x86_64.tar.gz"
KERNEL_URL="https://github.com/jlobue10/ALLY_Nobara_fixes/releases/download/v2.2.0/kernel-6.6.7-201.fsync.ally.fc38.x86_64.tar.gz"
