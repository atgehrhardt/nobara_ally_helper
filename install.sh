...
mkdir -p ~/.config/plasma_mobile-workspace/env/ && echo -e '#!/bin/bash\nunset GTK_IM_MODULE\nunset QT_IM_MODULE' > ~/.config/plasma_mobile-workspace/env/immodule_temp_fix.sh && chmod +x ~/.config/plasma_mobile-workspace/env/immodule_temp_fix.sh && ~/.config/plasma_mobile-workspace/env/immodule_temp_fix.sh
